...
static JSBool
jsImagePNG(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
   //
...
static JSBool
jsImageJPEG( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
   //
   // need at least data, plus optional x and y
   //
...
static JSBool
jsImageGIF( JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval )
{
   //
   // need at least data, plus optional x and y
   //
...
static JSFunctionSpec image_functions[] = {
    {"imagePNG",         jsImagePNG,        1 },
    {"imageJPEG",        jsImageJPEG,       1 },
    {"imageGIF",         jsImageGIF,        1 },
    {0}
};
